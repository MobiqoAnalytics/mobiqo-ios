...
Mobiqo.shared.syncUser(
    ...
    case .success(let response):
        ...
        print("Purchase probability: \(response.statistics.purchaseProbability)")
...
```swift
Mobiqo.shared.getUserInfo(revenueCatUserId: "user-123") { result in
    switch result {
    case .success(let userInfo):
        print("User info retrieved successfully")
        print("Purchase probability: \(userInfo.statistics.purchaseProbability)")
...
#### `syncUser(revenueCatUserId:additionalData:completion:)`
...
#### `getUserInfo(revenueCatUserId:completion:)`
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func syncCurrentUser() {
        // Get user ID from your authentication system or RevenueCat
        let userId = getCurrentUserId() // Your method to get user ID
    ...
    private func getCurrentUserId() -> String {
        // Return the current user's RevenueCat ID or your internal user ID
        return "user-12345"
    }
}
```
